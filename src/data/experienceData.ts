...
export const experienceData: ExperiencePosition[] = [
  ...
  },
  {
    ...
    status: "Present",
    responsibilities: [
      "Lead geometric road design and alignment studies for the Jimma Aba Jifar Airport to Bosona Jimma corridor and Bosona Jimma internal urban road network.",
      "Design and review horizontal/vertical roadway alignments, dual-carriageway cross-sections, and junction layouts using AutoCAD Civil 3D.",
      "Collaborate directly with civil contractors and local municipal authorities to resolve right-of-way (ROW) and complex terrain site design challenges.",
      "Generate parametric corridor models, calculate earthwork mass-haul quantities, and prepare comprehensive tender-ready technical drawing sets."
    ],
    keyProjectInvolvement: [
      "Jimma Aba Jifar Airport to Bosona Jimma Road Project",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Coordinated with multidisciplinary engineering teams (hydrology, structural, geotechnical) to meet stringent project deadlines."
    ],
    keyProjectInvolvement: [
  ...
  },
  {
    ...
    status: "Completed",
    responsibilities: [
      "Architected and deployed an AI conversational chatbot and personalized recommendation engine leveraging user customer data.",
  ...
  },
  {
    ...
    keyProjectInvolvement: [
      ...
      "Quality Assurance & Formwork Inspection"
    ],
    toolsUsed: [
      "Site Supervision",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Tracked material consumption rates (cement, aggregates, reinforcing steel, bitumen) to prevent site wastage.",
      "Conducted twice-a-day site safety inspections and identified operational hazards across work zones.",
      "Assisted senior resident engineers in survey verification, centerline setting out, and interim quantity measurements."
    ],
    keyProjectInvolvement: [
      "Road Rehabilitation Construction Monitoring",
      "Daily Progress & Materials Usage Tracking",
      "Site Safety & Environmental Compliance Auditing"
    ],
    toolsUsed: [
